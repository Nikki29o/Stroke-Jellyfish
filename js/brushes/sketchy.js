...
sketchy.prototype =
{
    ...
    stroke: function( x, y)
    {
        ...
        for (var i = 0; i < this.points.length; i++)
        {
            ...
            {
                strokeContext.beginPath();
                strokeContext.moveTo( this.points[this.count][0] + (dx * 0.3), this.points[this.count][1] + (dy * 0.3));
                strokeContext.lineTo( this.points[i][0] - (dx * 0.3), this.points[i][1] - (dy * 0.3));
                strokeContext.stroke();
            }
        }
